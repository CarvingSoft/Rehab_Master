...
export class ClientRegistrationService {
  updateRoutineForm(data: { routine: { clientid: string; toiletingAndBath: unknown; toiletTrained: unknown; dayAndNight: unknown; accidents: unknown; toiletPaperUse: unknown; managingClothing: unknown; washingHands: unknown; bathingAndBrushing: unknown; typicalNightSleep: unknown; typicalWakeup: unknown; homework: unknown; routineStrategies: unknown; difficultSituation: unknown; howYouKnowAboutUs: unknown; }; }) {
