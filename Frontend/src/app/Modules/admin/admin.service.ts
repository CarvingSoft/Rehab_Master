...
export class AdminService {
  ...
  // getPaginatedAssessment(search: string, page: number, pageSize: number): Observable<Assessment[]> {

  //   const searchTerm = search ? `&search=${search}` : '';
  //   return this._http.get<Assessment[]>(`${this.url}/assessment?page=${page}&pageSize=${pageSize}${searchTerm}`);
  // }
