...
router.post('/stassessmentform', authToken, async(req,res)=>{
    try {
            const{date, updatedDate, assessmentMasterId,childStrength,parentConcern ,babbling ,firstWord ,twoWord ,regression ,impressionSpeech ,neckControl ,sitting ,
                walking ,impressionMotor ,structureLip, FunctionLip ,structureTounge ,functionTounge ,structureTeeth ,functionTeeth ,
            ...
            const stAssessmentForm = new StAssessment({date, updatedDate, assessmentMasterId,childStrength,parentConcern ,babbling ,firstWord ,twoWord ,regression ,impressionSpeech ,neckControl ,sitting ,
                walking ,impressionMotor ,structureLip, FunctionLip ,structureTounge ,functionTounge ,structureTeeth ,functionTeeth ,
                structureAlveolus ,functionAlveolus ,structurePalate ,functionPalate ,structureUvula ,functionUvula ,structureMandible ,
                functionMandible ,sucking ,swallowing ,biting ,chewing ,blowing ,drooling ,otherConsultation ,eyeContact ,attentionConcentration ,
                sittingTolerance ,speechSkills ,fluencyProfile ,speechRate ,effort ,prosody ,speechRating ,stimulability ,phonologyProfile ,
